...
class FarmListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'name', 'owner', 'centroid', 'area', 'municipality', 'state']
...
class FarmDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Farm
        fields = '__all__'
        read_only_fields = ['id', 'name', 'owner', 'geometry', 'centroid', 'area', 'municipality', 'state', 'creation_date', 'last_modification_date', 'is_active']
